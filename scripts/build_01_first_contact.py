"""Build notebooks/01_first_contact.ipynb.
...
OUT = Path(__file__).resolve().parents[1] / "notebooks" / "01_first_contact.ipynb"
...
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/Innixma/kdd2026_tutorial_materials/blob/main/notebooks/01_first_contact.ipynb)
...
| TabFM | *not in AutoGluon; `tabfm` library* | 2026-06 | ~100,000 | — | — | all | Code Apache-2.0; weights noncommercial |
| EXAONE-Tabular | *not in AutoGluon; tabarena wrapper* | 2026-07 | ~500,000 | — | — | all | Code BSD-3-Clause-LG; weights noncommercial (EXAONE 1.1-NC) |
...
- AutoGluon's `extreme` and `noncommercial` presets (notebook 02) bundle these models into
...
**Next**: [notebook 02](https://colab.research.google.com/github/Innixma/kdd2026_tutorial_materials/blob/main/notebooks/02_autogluon_essentials.ipynb) puts these models to work automatically through AutoGluon. Preview of
