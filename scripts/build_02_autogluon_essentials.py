"""Build notebooks/02_autogluon_essentials.ipynb.
...
polish_companies_bankruptcy (the dataset from notebook 01, official benchmark split), with
...
OUT = Path(__file__).resolve().parents[1] / "notebooks" / "02_autogluon_essentials.ipynb"
