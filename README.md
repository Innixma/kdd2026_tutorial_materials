...
| [`03_inside_the_prior.ipynb`](notebooks/03_inside_the_prior.ipynb) | The synthetic prior TFMs are pretrained on, generated live via nanotabicl | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/Innixma/kdd2026_tutorial_materials/blob/main/notebooks/03_inside_the_prior.ipynb) |
| [`04_tfm_zoo.ipynb`](notebooks/04_tfm_zoo.ipynb) | AutoGluon as an optimized model zoo for TFMs: many foundation models, one predictor | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/Innixma/kdd2026_tutorial_materials/blob/main/notebooks/04_tfm_zoo.ipynb) |
| [`05_thinking_mode.ipynb`](notebooks/05_thinking_mode.ipynb) | TabPFN-3 thinking mode conquers the high-cardinality-categorical dataset where TFMs lose to CatBoost | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/Innixma/kdd2026_tutorial_materials/blob/main/notebooks/05_thinking_mode.ipynb) |
| [`06_noniid_validation.ipynb`](notebooks/06_noniid_validation.ipynb) | Non-IID data: a naive split vs `validation_structure` on grouped data, where the naive estimate is off 25x | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/Innixma/kdd2026_tutorial_materials/blob/main/notebooks/06_noniid_validation.ipynb) |
| [`07_timeseries_forecasting.ipynb`](notebooks/07_timeseries_forecasting.ipynb) | Time series forecasting with AutoGluon | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/Innixma/kdd2026_tutorial_materials/blob/main/notebooks/07_timeseries_forecasting.ipynb) |
