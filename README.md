...
| [`07_noniid_validation.ipynb`](notebooks/07_noniid_validation.ipynb) | Non-IID data: a naive split vs `validation_structure` on grouped data, where the naive estimate is off 25x | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/Innixma/kdd2026_tutorial_materials/blob/main/notebooks/07_noniid_validation.ipynb) |
| [`08_timeseries_forecasting.ipynb`](notebooks/08_timeseries_forecasting.ipynb) | Time series forecasting with AutoGluon | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/Innixma/kdd2026_tutorial_materials/blob/main/notebooks/08_timeseries_forecasting.ipynb) |
